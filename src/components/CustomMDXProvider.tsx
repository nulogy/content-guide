...
const components: Readonly<MDXComponents> = {
  ...
  p: (props) => <Text maxWidth={COPY_WIDTH} mb="x4" mx="auto" {...props} />,
  blockquote: (props) => (
    <Text maxWidth={COPY_WIDTH} fontSize="24px" mb="x4" mx="auto" {...props} />
  ),
  ul: (props) => <List maxWidth={COPY_WIDTH} mb="x4" mx="auto" {...props} />,
  li: (props) => <ListItem maxWidth={COPY_WIDTH} {...props} />,
  // @ts-ignore
  a: (props) => <Link maxWidth={COPY_WIDTH} ref={props.ref} {...props} />,
  table: (props) => (
    <table
      style={{
        width: "100%",
