...
<Flex justifyContent="space-between" maxWidth={COPY_WIDTH} m="0 auto" mb="x4">
  ...
  <Box>
    <YesExample>
      <Text fontSize="small" mt="x2">To assign pallets through item locator: </Text>
...
<Flex justifyContent="space-between" maxWidth={COPY_WIDTH} m="0 auto" mb="x4">
  <Box>
    <NoExample>
      <Text fontSize="small" mt="x2">Attachment information includes:</Text>
      <List fontSize="small" mt="x2">
...
<NoExample fontSize="small">This content guide includes section on voice, tone and grammar.</NoExample>
<YesExample fontSize="small" mb="x4">This content guide includes sections on voice, tone, and grammar.</YesExample>
...
<Flex justifyContent="space-between" maxWidth={COPY_WIDTH} m="0 auto" mb="x4">
  <Box>
    <NoExample>
      <Text fontSize="small" mt="x2">Use Nulogy's Shop Floor Control to report on:</Text>
      <List fontSize="small" mt="x2">
        <ListItem>
  ...
  <Box>
    <YesExample>
      <Text fontSize="small" mt="x2">Use Nulogy's Shop Floor Controp to report on:</Text>
      <List fontSize="small" mt="x2">
